...
export const EditContact = () => {
	...
	return (
		...
		} else{actions.editContact(name, email, phone, address, store.editId); document.getElementById('address').value = ''; document.getElementById('name').value = ''; document.getElementById('email').value = '';document.getElementById('phone').value = ''}}}>Click Here To add a new Contact</button>
			</ul>
			<br />
			<p>Edit ID : {store.editId}</p>
			<Link to="/">
